...
public class HttpTaskServer {
    ...
    public static void main(String[] args) throws IOException {
        HttpTaskServer server1 = new HttpTaskServer(new InMemoryTaskManager());
        server1.start();
    }
    ...
    private static class Handler implements HttpHandler {
        ...
        private void handleGetPrioritized(HttpExchange exchange) throws IOException {
            Collection<Task> prioritized = manager.getPrioritet();
        ...
        private void handleGetById(HttpExchange exchange, String[] urlParts) throws IOException {
            ...
            if (urlParts.length == 4 && urlParts[2].equals("task")) {
                ...
                try {
                    writeResponse(exchange, gson.toJson(manager.getSubTaskForEpic(id)), 200);
                } catch (NoSuchElementException e) {
                    writeResponse(exchange, e.getMessage(), 404);
                }
            } else {
            ...
            try {
                ...
                switch (exchange.getRequestURI().getPath()) {
                    case "/tasks/task/":
                        ...
                        writeResponse(exchange, "Task создана", 201);
                        break;
                    case "/tasks/epic/":
                    ...
                    case "/tasks/subtask/":
                        ...
                        writeResponse(exchange, "Subtask создана", 201);
                        break;
                    default:
                        writeResponse(exchange, "Неправильный запрос", 400);
                        break;
